...
logical_and = get_binary_operator('logical_and', logical_and_op)
logical_or = get_binary_operator('logical_or', logical_or_op)
logical_xor = get_binary_operator('logical_xor', logical_xor_op)
