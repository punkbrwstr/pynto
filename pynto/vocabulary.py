...
logical_and = lambda: main.BinaryOperator('logical_and', operation=main.logical_and_op)
logical_or = lambda: main.BinaryOperator('logical_or', operation=main.logical_or_op)
logical_xor = lambda: main.BinaryOperator('logical_xor', operation=main.logical_xor_op)
...
is_na = lambda: main.get_unary_operator('is_na', main.is_na_op)
